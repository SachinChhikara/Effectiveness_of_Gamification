...
The results from pretest(@tb-pretest) are pretty such the same for each group which aligns with the fact that this study was given before the experiment began. 
