...
#| message: false
#| label: fig-social_gamification
#| table-cap: "Social gamification website: Gamification tools (left), dashboard (top-right) & leaderboard (bottom-right)."
