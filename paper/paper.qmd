...
In database post test(@fig-boxplot), the educational game performed as worse the control group. And similarly to the presentation posttest the social gamification does worse than the social network and gamification plugin. And gamification plugin does slightly better than social network.
